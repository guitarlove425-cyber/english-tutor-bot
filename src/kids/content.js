...
const LESSON_DATA = [
    ...
    ['Phonics: My First Words', 'အသံပေါင်းပြီး ကိုယ်ပိုင် CVC စကားလုံးများ ဖတ်ရန်', 'short a/e word families', 'cat, hat, bed, red', 'I can read a short word.', 'CVC စကားလုံး ၄ လုံးကို ဖတ်ပြီး ပုံတစ်ပုံနဲ့ တွဲပါ။', 'discovery'],
    ...
    ['Nature Words', 'အပြင်ဘက်က အရာဝတ္ထုများကို အရောင်နဲ့ အရွယ်ဖြင့် ဖော်ပြရန်', 'It is / They are', 'tree, flower, leaf, sky, small, tall', 'The tree is tall.', 'အပင် သို့မဟုတ် သဘာဝအရာ ၃ ခုကို ရွေးပြီး ဖော်ပြပါ။', 'primary'],
    ...
    ['Weekend Plans', 'အပတ်ကုန်မှာ လုပ်မည့်အစီအစဉ်ကို ပြောရန်', 'I am going to...', 'Saturday, Sunday, visit, play, help', 'I am going to visit my grandmother.', 'အပတ်ကုန်အစီအစဉ် ၃ ခုကို အစဉ်လိုက် ပြောပါ။', 'elementary'],
    ...
    ['Story with a Problem', 'ပြဿနာတစ်ခုနဲ့ ဖြေရှင်းနည်းကို story ထဲမှာ ပြောရန်', 'There was a problem / We decided to...', 'problem, idea, choose, solve, safe', 'There was a problem, so we found a safe idea.', 'ပုံပြင်တိုတစ်ခုကို ပြဿနာ၊ အကြံ၊ ဖြေရှင်းချက်နဲ့ ပြောပါ။', 'junior'],
    ...
    ['Research and Poster', 'အချက်အလက် ၂ ခုကို ရှာဖွေပြီး poster အဖြစ် ရှင်းပြရန်', 'It is important because... / First, next, finally', 'fact, source, protect, explain, audience', 'First, I found two facts. Next, I made a poster.', 'အကြောင်းအရာတစ်ခုအတွက် fact ၂ ခု၊ poster ခေါင်းစဉ်နဲ့ ရှင်းပြချက်တစ်ခု ပြုလုပ်ပါ။', 'academic'],
    ...
    ['Young Pro Reflection', 'တင်ပြမှုအပေါ် ကိုယ်တိုင်သုံးသပ်ပြီး နောက်တစ်ဆင့်ရည်မှန်းချက် ချမှတ်ရန်', 'I improved... / Next time I will...', 'reflect, strength, target, improve, audience', 'I improved my clarity, and next time I will use stronger examples.', 'ကိုယ့်တင်ပြမှုရဲ့ အားသာချက် ၂ ခု၊ ပြင်ရန်အချက် ၁ ခုနဲ့ နောက်ရည်မှန်းချက်ကို ပြောပါ။', 'pro']
];
