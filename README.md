...
Real-life Projects are available through `/projects` or the Practice submenu. Project milestones range from self-introduction and daily routine to travel problem solving, presentations, professional proposals, and an Advanced/Pro position defense. Text and voice submissions are assessed with a six-part rubric: clarity, grammar, vocabulary, fluency, pronunciation/clarity, and task completion. A project is marked ready only when the rubric demonstrates the task criteria; otherwise the learner receives a Burmese explanation, one corrected English example, and a retry task.
...
The Kids classroom begins with letter names, phonics, short vowels, sound blending, colors, and numbers. Kids explanations use tiny steps, repetition, simple Burmese, two easy models, one gentle correction, and one action at a time so a child is not overwhelmed. It then progresses through family, school, manners, feelings, weather, stories, questions, role-play, opinions, reading main ideas, paragraph writing, mini-presentations, projects, discussion, advanced storytelling, formal writing, presentation Q&A, and a Young Pro capstone. Each lesson stays short, uses simple Burmese instructions, preserves English target content, accepts text or voice practice, and uses the same mastery gate before allowing the next lesson.
